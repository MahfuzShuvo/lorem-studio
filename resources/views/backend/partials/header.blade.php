<div class="nk-header nk-header-fixed nk-header-fluid is-theme">
        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand">
                <a href="{{ url('/admin/dashboard') }}" class="logo-link">
                    <img class="logo-light logo-img" src="{{asset('public/admin/assets/images/logo.svg')}}" srcset="{{asset('public/admin/assets/images/logo.svg')}}" alt="logo">
                    <img class="logo-dark logo-img" src="{{asset('public/admin/assets/images/logo-dark.svg')}}" srcset="{{asset('public/admin/assets/images/logo-dark.svg')}}" alt="logo-dark">
                </a>
            </div><!-- .nk-header-brand -->
            <div class="nk-header-menu" data-content="headerNav">
                ...
                <ul class="nk-menu nk-menu-main ui-s2">
                    ...
                    <li class="nk-menu-item has-sub">
                        <a href="{{ route('admin.hireus') }}" class="nk-menu-link">
                            <span class="nk-menu-text">Hire us</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item has-sub">
