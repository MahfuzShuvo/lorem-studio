                    ...
                    <div class="nk-block">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <form action="{{ url('/save_service') }}" class="gy-3" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <textarea class="form-control @error('description') is-invalid @enderror" value="" name="description"></textarea>
                                                    @error('description')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
